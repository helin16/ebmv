...
class SC_XinHua extends SupplierConnectorAbstract implements SupplierConn
{
	 ...
	 */
	private function _importCatalogList($lastUpdateDate, $index = 1, $pageSize = DaoQuery::DEFAUTL_PAGE_SIZE, $totalPages = 0)
	{
		...
		if($index < $totalPages) {
			...
			$this->_importCatalogList($lastUpdateDate, $index + 1, $pageSize, $totalPages);
		}
	}
}