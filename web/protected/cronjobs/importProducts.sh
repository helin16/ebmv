/usr/bin/php /var/www/ebmv/web/protected/cronjobs/ImportProduct_Run.php all 2 all 3 > /tmp/productImport_`date +"%d_%b_%y"`_YuanLiu_Magazine.log
...
/usr/bin/php /var/www/ebmv/web/protected/cronjobs/ImportProduct_Run.php all 12 all > /tmp/productImport_`date +"%d_%b_%y"`_DLTX.log
