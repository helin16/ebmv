...
<h3 class="questionsub">
如何使用eBMV中文电子资源?
</h3>
<dd>
你可以从图书馆网页上的链接进入eBMV中文电子资源网页. 在登录之前你可以浏览和搜寻目录, 也可以预览每本电子书的开始部分. 如果你要阅读一本电子书的全部, 或者阅读报纸和杂志, 请先登录. 登录号是你的图书馆卡号和密码. 
</dd>
<h3 class="questionsub">
如何使用eBMV中文電子資源? 
</h3>
<dd>
你可以從圖書館網頁上的鏈接進入eBMV中文電子資源網頁. 在登錄之前你可以流覽和搜尋目錄, 也可以預覽每本電子書的開始部份. 如果你要閱讀一本電子書的全部, 或者閱讀報紙和雜誌, 請先登錄. 登錄號是你的圖書館卡號和密碼. 
</dd>
</dl>',
...
<dd>
在目录上选择你要读的简体中文电子书, 点击封面.  在新的网页上有这本书的元数据, 还有两个按钮供选择: “在线阅读” 和 “下载阅读”.  在线阅读可在运行微软公司视窗, 苹果公司OS和安卓操作系统的桌上, 手提和平板电脑上实现. 
</dd>
</dl>',
...
<dd>
在目录上选择你要读的简体中文电子书, 点击封面.在新的网页上有这本书的元数据, 还有两个按钮供选择: “在线阅读” 和 “下载阅读”. 
</dd>
<dd>
下载阅读现只可以在运行微软公司视窗操作系统(Windows XP SP2, Vista, Windows7)的桌上, 手提和平板电脑上实现. 下载的文件是一个已包含阅读器的压缩文件 (.zip).  经解压之后得到一个执行文件(.exe).  双击此文件即可开始阅读. 
</dd>
</dl>',
...
<dd>
简体中文电子报刊, 电子杂志服务支持在线阅读. 读者可以从图书馆网页上的链接进入eBMV中文电子资源网页. 在登录之前你可以浏览和搜寻目录. 登录后选择中意的电子报刊可在运行微软公司视窗, 苹果公司OS和安卓操作系统的桌上, 手提和平板电脑上阅读. 
</dd>
</dl>',
...
<dd>
If you want to read on your iOS device or Android device, go to the App Store or Google Play
...
<dd>
在目錄上選擇你要閱讀的繁體中文電子書和電子雜誌, 點擊封面. 在新的網頁上有此出版物的元數據, 以及一個”借閱”按鈕. 借閱后你即可以在PC, NB, 平板電腦上連線閱讀.如要用苹果或安卓移动终端離線閱讀, 需先到Apple App Store或 Google Play 下載臺灣雲端書庫2014 app.
</dd>
</dl>'     		
        );
