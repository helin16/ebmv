        ...
        $array = array(
			 array (
        		'en' => array (
        			...
        			,'answer'   => 'You can access eBMV Chinese Language e-Resource via the link on your library’s website. You can browse and search catalogue, or preview e-books before you login. If you’d like to read a whole e-book, or read newspaper and magazine, please login with your library card and PIN.'
				)
			 	,'zh_cn' => array (
        			'question' => "如何使用eBMV中文电子资源?"
        			,'answer'  => '你可以从图书馆网页上的链接进入eBMV中文电子资源网页. 在登录之前你可以浏览和检索目录, 也可以预览每本电子书的开始部分. 如果你要阅读一本电子书的全部, 或者阅读报纸和杂志, 请先登录. 登录号是你的图书馆卡号和密码.'
				)
			 	,'zh_tw' => array (
