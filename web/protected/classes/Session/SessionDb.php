...
class SessionDb extends THttpSession
{
    ...
    */
    ...
    {
        return BaseService::getInstance('Session')->read($id);
    }
    /**
    ...
    {
        $session = BaseService::getInstance('Session')->write($id, $data);
    ...
    {
        BaseService::getInstance('Session')->delete($id);
        return true;
    }
    ...
    {
        BaseService::getInstance('Session')->cleanUp($maxLifetime);
        return true;
    }
}